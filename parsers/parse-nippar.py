...
def nipper_parser(nipper_xml_file, output_filename):
	with open(output_filename, "wb") as outFile:
		...
		for server_info in server_info_list:
			...
			_device_ips = ",\n".join(_ip_list)
			master_endpoint_table[_device_name] = {'os': _device_os, 'device_description': _device_description,
			                                       'fqdn': _device_name, 'ip_address': _device_ips}
...
if __name__ == "__main__":
	...
	aparser = argparse.ArgumentParser(
		description='Converts Nipper Security and Vulnerability Audit section XML results '
		            'into two .csv files.')
