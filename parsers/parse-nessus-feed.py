...
def max_field_len_excel(ggchild, row_number):
	...
	if len(field) > 32767:
		...
		print "Row {}, '{}' was truncated. The remainder can be found here: {}".format(row_number, ggchild[0].text,
		                                                                               fname)
...
def get_sum_from_xml(filename):
	...
	results_table = [
		["Vulnerability", "CVSS Base Score", "Description", "Remediation", "Published", "Updated", "See Also"]]
