...
import os
from discover import banner, colorblue
...
if choice == "2":
	...
	time.sleep(1)
	webbrowser.open(
		'http://search.nndb.com/search/nndb.cgi?nndb=1&omenu=unspecified&query=' + firstname + '+' + lastname)
	time.sleep(1)
	webbrowser.open('http://www.spokeo.com/search?q=' + firstname + '+' + lastname + '&s3=t24')
	time.sleep(1)
	webbrowser.open(
		'http://www.zabasearch.com/query1_zaba.php?sname=' + firstname + '%20' + lastname + '&state=ALL&ref=$ref&se=$se&doby=&city=&name_style=1&tm=&tmr=')
